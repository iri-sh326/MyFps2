...
namespace Unity.FPS.Gameplay
{
    public class ChargedWeaponEffectHandler : MonoBehaviour
    {
        ...
        public GameObject diskOrbitParticePrefab;            // 발사체를 감싸고 있는 회전하는 이펙트
        ...
        private float chargeRatio;                      // 현재 충전율
        ...
        private void Awake()
        {
            ...
            audioSourceLoop.clip = chargeSound;
        ...
        {
            particleInstance = Instantiate(diskOrbitParticePrefab, parentTransform != null ? parentTransform : transform);
